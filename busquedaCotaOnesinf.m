...
% el procedimiento consiste en calcular un vector aleatorio con 1 y -1's
...
function cota_infimo = busquedaCotaOnesinf(A)
  y = randones(length(A));  % Inicializamos vector infimo aleatorio con
                            % valores -1 o 1
